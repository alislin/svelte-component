...
{#if isShown}
    <div class="modal-wrap">
        <div class="mask" on:click={closeByMask} in:fade={{ delay: 250, duration: 300 }} out:fade={{ delay: 250, duration: 300 }} />
        <div class="modal-content" in:fade={{ delay: 250, duration: 300 }} out:fade={{ delay: 250, duration: 300 }}>
            <div class="header">
                <div class="title">{title}</div>
                <div>
                    {#if isCloseShown}
                        <button class="close" on:click={close}>
                            <svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2161" width="20" height="20">
                                <path
